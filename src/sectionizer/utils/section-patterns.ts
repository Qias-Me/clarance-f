 ...
 */
export const strictSectionPatterns: Record<string, RegExp[]> = {
  "1": [
 ...
 */
export const strictSectionPatternsNumeric: Record<number, RegExp[]> = {
 ...
 */
export const sectionFieldPatterns: Record<number, { fields: number, entries: number, subsections: number }> = {
 ...
 */
export function isFieldInSection(fieldName: string, section: number): boolean {
