...
import type { PDFField } from '../utils/extractFieldsBySection.js';

// Mock bridge adapter functions
jest.mock('../utils/bridgeAdapter.js', () => ({
  extractSectionInfo: jest.fn().mockImplementation((name: string) => {
  ...
  pageRangeLookup: jest.fn().mockImplementation((page: number) => {
  ...
  fallbackCategorization: jest.fn().mockImplementation((field: PDFField) => {
...
describe('EnhancedPdfValidator', () => {
  ...
  describe('validateFields', () => {
    ...
    it('should validate clean field data', () => {
      const cleanFields: FieldMetadata[] = [
        {
          id: 'field1',
          name: 'clean_field1',
          value: 'test',
  ...
  describe('generateQualityReport', () => {
    it('should generate quality metrics for fields', () => {
      ...
      const enrichedFields: EnhancedField[] = [
        {
          id: 'field1',
          name: 'section1_field',
          value: 'value1',
