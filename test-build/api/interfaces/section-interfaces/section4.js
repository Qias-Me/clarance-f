...
exports.validateAndUpdateSSN = exports.updateMainSSNAndPropagate = exports.propagateSSNToAllFields = exports.getAllSSNFieldNames = exports.getAllSSNFieldIds = exports.validateSSN = exports.formatSSN = exports.updateSection4Field = exports.createDefaultSection4 = exports.SECTION4_FIELD_NAMES = exports.SECTION4_FIELD_IDS = void 0;
...
exports.SECTION4_FIELD_IDS = {
    ...
    SSN_AUTO_75: "14012", // form1[0].#subform[80].SSN[10]
    SSN_AUTO_76: "14077", // form1[0].#subform[83].#subform[84].SSN[11]
    SSN_AUTO_77: "14117", // form1[0].#subform[87].SSN[12]
    SSN_AUTO_78: "14155", // form1[0].#subform[89].SSN[13]
    SSN_AUTO_79: "14166", // form1[0].#subform[91].SSN[14]
    SSN_AUTO_80: "14233", // form1[0].#subform[92].SSN[15]
    SSN_AUTO_81: "14255", // form1[0].#subform[93].SSN[16]
    SSN_AUTO_82: "14295", // form1[0].#subform[94].SSN[17]
    SSN_AUTO_83: "14356", // form1[0].#subform[95].SSN[18]
    SSN_AUTO_84: "14383", // form1[0].Section21a[0].SSN[0]
    SSN_AUTO_85: "14432", // form1[0].Section21a2[0].SSN[0]
    SSN_AUTO_86: "14460", // form1[0].Section21b[0].SSN[0]
    SSN_AUTO_87: "14463", // form1[0].Section21b2[0].SSN[0]
    SSN_AUTO_88: "14534", // form1[0].Section21c[0].SSN[0]
    SSN_AUTO_89: "14620", // form1[0].section21d1[0].SSN[0]
    SSN_AUTO_90: "14689", // form1[0].section21d2[0].SSN[0]
    SSN_AUTO_91: "14705", // form1[0].Section21d3[0].SSN[0]
    SSN_AUTO_92: "14765", // form1[0].Section21e[0].SSN[0]
    SSN_AUTO_93: "14872", // form1[0].Section21e1[0].SSN[0]
    SSN_AUTO_94: "14874", // form1[0].Section22_1[0].SSN[0]
    SSN_AUTO_95: "14935", // form1[0].Section22_2[0].SSN[0]
    SSN_AUTO_96: "14997", // form1[0].Section22_3[0].SSN[0]
    SSN_AUTO_97: "15022", // form1[0].Section22_4[0].SSN[0]
    SSN_AUTO_98: "15038", // form1[0].Section22_5[0].SSN[0]
    SSN_AUTO_99: "15088", // form1[0].Section22_6[0].SSN[0]
    SSN_AUTO_100: "15173", // form1[0].Section22_3_1[0].SSN[0]
    SSN_AUTO_101: "15202", // form1[0].Section23_1[0].SSN[0]
    SSN_AUTO_102: "15273", // form1[0].Section23_2[0].SSN[0]
    SSN_AUTO_103: "15276", // form1[0].Section_23_3[0].SSN[0]
    SSN_AUTO_104: "15324", // form1[0].Section_23_4[0].SSN[0]
 ...
 */
const createDefaultSection4 = () => ({
    _id: 4,
    section4: {
        notApplicable: {
            id: exports.SECTION4_FIELD_IDS.NOT_APPLICABLE,
            name: exports.SECTION4_FIELD_NAMES.NOT_APPLICABLE,
            type: "PDFCheckbox",
            label: "Not Applicable",
            value: false,
        },
        Acknowledgement: {
            id: exports.SECTION4_FIELD_IDS.ACKNOWLEDGEMENT,
            name: exports.SECTION4_FIELD_NAMES.ACKNOWLEDGEMENT,
            type: "PDFRadioGroup",
        ...
        ssn: [
            {
                value: {
                    id: exports.SECTION4_FIELD_IDS.SSN_MAIN,
                    name: exports.SECTION4_FIELD_NAMES.SSN_MAIN,
                    type: "PDFTextField",
...
exports.createDefaultSection4 = createDefaultSection4;
/**
 * Updates a specific field in the Section 4 data structure
 */
const updateSection4Field = (section4Data, update) => {
    const { fieldPath, newValue } = update;
    const newData = { ...section4Data };
    (0, lodash_set_1.default)(newData, fieldPath, newValue);
    return newData;
};
exports.updateSection4Field = updateSection4Field;
/**
 ...
 */
const getAllSSNFieldIds = () => {
    return [
        exports.SECTION4_FIELD_IDS.SSN_CONTINUATION,
        ...Array.from({ length: 136 }, (_, i) => {
            const fieldKey = `SSN_AUTO_${i + 1}`;
            return exports.SECTION4_FIELD_IDS[fieldKey];
        }),
    ];
};
exports.getAllSSNFieldIds = getAllSSNFieldIds;
/**
 * Gets all SSN field names for auto-population
 */
const getAllSSNFieldNames = () => {
    return [
        exports.SECTION4_FIELD_NAMES.SSN_CONTINUATION,
        ...Array.from({ length: 136 }, (_, i) => {
            const fieldKey = `SSN_AUTO_${i + 1}`;
            return exports.SECTION4_FIELD_NAMES[fieldKey];
        }),
    ];
};
exports.getAllSSNFieldNames = getAllSSNFieldNames;
/**
 * Propagates the main SSN value to all other SSN fields in the section
 * This ensures consistency across the entire PDF form
 */
const propagateSSNToAllFields = (section4Data, mainSSNValue) => {
    ...
    const allFieldIds = (0, exports.getAllSSNFieldIds)();
    const allFieldNames = (0, exports.getAllSSNFieldNames)();
    // Create field updates for all auto-fill SSN fields
    const fieldUpdates = allFieldIds.map((fieldId, index) => ({
    ...
    if (!updatedData.section4.ssn[1]) {
        ...
        fieldUpdates.forEach((update) => {
            updatedData = (0, exports.updateSection4Field)(updatedData, update);
        });
    }
    return updatedData;
};
exports.propagateSSNToAllFields = propagateSSNToAllFields;
/**
 ...
 */
const updateMainSSNAndPropagate = (section4Data, newSSNValue) => {
    // Propagate to all fields
    return (0, exports.propagateSSNToAllFields)(section4Data, newSSNValue);
};
exports.updateMainSSNAndPropagate = updateMainSSNAndPropagate;
/**
 * Validates and updates the main SSN field with auto-propagation
 */
const validateAndUpdateSSN = (section4Data, newSSNValue, context, shouldFormat = true) => {
    // Validate the SSN
    const validationResult = (0, exports.validateSSN)(newSSNValue, context);
    // Update and propagate if valid, or just update if validation allows it
    const updatedData = (0, exports.updateMainSSNAndPropagate)(section4Data, newSSNValue);
    return {
        updatedData,
        validationResult,
    };
};
exports.validateAndUpdateSSN = validateAndUpdateSSN;
