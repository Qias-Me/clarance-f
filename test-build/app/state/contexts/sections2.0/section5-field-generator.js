...
exports.validateFieldId = exports.getFieldInputType = exports.generateFieldLabel = exports.generateFieldRect = exports.generateFieldName = exports.generateFieldId = exports.SUFFIX_OPTIONS = void 0;
exports.generateCompleteField = generateCompleteField;
exports.validateEntryFieldGeneration = validateEntryFieldGeneration;
exports.validateAllSection5FieldGeneration = validateAllSection5FieldGeneration;
const section5_field_mapping_1 = require("./section5-field-mapping");
const section5_1 = require("../../../../api/interfaces/section-interfaces/section5");
/**
 ...
 */
const generateFieldId = (entryIndex, fieldType) => {
    ...
    const numericId = (0, section5_field_mapping_1.getNumericFieldId)(fallbackFieldName);
    if (numericId) {
 ...
 */
const generateFieldName = (entryIndex, fieldType) => {
    // For main questions, use exact field name
    if (fieldType === 'hasOtherNames') {
        return section5_1.SECTION5_FIELD_NAMES.HAS_OTHER_NAMES;
    }
    if (fieldType === 'hasMaidenNames') {
        return section5_1.SECTION5_FIELD_NAMES.HAS_MAIDEN_NAMES;
    }
 ...
 */
const generateFieldRect = (entryIndex, fieldType) => {
...
exports.generateFieldRect = generateFieldRect;
/**
 ...
 */
const generateFieldLabel = (fieldType, entryIndex) => {
...
exports.generateFieldLabel = generateFieldLabel;
/**
...
exports.getFieldInputType = getFieldInputType;
/**
 ...
 */
function generateCompleteField(entryIndex, fieldType, defaultValue, options) {
    const fieldId = (0, exports.generateFieldId)(entryIndex, fieldType);
    const fieldName = (0, exports.generateFieldName)(entryIndex, fieldType);
    const fieldRect = (0, exports.generateFieldRect)(entryIndex, fieldType);
    const fieldLabel = (0, exports.generateFieldLabel)(fieldType, entryIndex);
    // Get field metadata for type information
    const fieldMetadata = (0, section5_field_mapping_1.getPdfFieldByName)(fieldName);
 ...
 */
function validateEntryFieldGeneration(entryIndex) {
    console.log(`🔍 Section5: Validating field generation for entry ${entryIndex}`);
    const requiredFields = ['lastName', 'firstName', 'middleName', 'suffix', 'from', 'fromEstimate', 'to', 'toEstimate', 'reasonChanged', 'present', 'isMaidenName'];
    for (const fieldType of requiredFields) {
        ...
        if (!(0, section5_field_mapping_1.validateFieldExists)(pdfFieldName)) {
 ...
 */
function validateAllSection5FieldGeneration() {
    // console.log(`🔍 Section5: Validating all Section 5 field generation`);
    // Validate main field
    const mainFieldName = (0, section5_field_mapping_1.mapLogicalFieldToPdfField)('section5.hasOtherNames.value');
    if (!(0, section5_field_mapping_1.validateFieldExists)(mainFieldName)) {
