import { PDFCheckBox, PDFDocument, PDFDropdown, PDFName, PDFRadioGroup, PDFString, PDFTextField } from 'pdf-lib';
...
export class ClientPdfService {
    ...
    async loadPdf() {
        ...
        try {
            ...
            throw new Error("Unable to load SF86 PDF. Please upload a SF86 PDF file instead.");
        }
        catch (error) {
     ...
     */
    async loadPdfFromBuffer(pdfBuffer) {
        try {
     ...
     */
    async mapFormValuesToJsonData(fieldMapping, formData) {
        ...
        if (this.fieldHierarchy) {
            try {
                ...
                const mappedFields = fieldMapping.map(field => ({ ...field }));
     ...
     */
    async generateFilledPdf(formData) {
        try {
     ...
     */
    downloadPdf(pdfBytes, filename = 'SF86-filled.pdf') {
