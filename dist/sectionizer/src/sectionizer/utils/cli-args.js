 ...
 */
export function configureCommandLineParser() {
    ...
    program
        ...
        .version("2.0.0");
    program
        .option("-p, --pdf-path <path>", "Path to the SF-86 PDF file to process")
        .option("-i, --input-fields <path>", "Path to input JSON file containing extracted fields to process")
 ...
 */
export function configureUtilityCommandParser(description) {
    const program = new Command();
    program
        .name("utility-script")
 ...
 */
export function parseUtilityArgs(program, argv) {
    program.parse(argv || process.argv);
    return program.opts();
}
/**
 ...
 */
function parseIntOption(value, defaultValue = 0) {
