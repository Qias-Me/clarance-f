 ...
 */
export function log(level, message, includeTimestamp = true) {
    if (!shouldLog(level))
        return;
 ...
 * @param includeTimestamp Whether to include a timestamp
 */
export function debug(message, includeTimestamp = true) {
 ...
 * @param includeTimestamp Whether to include a timestamp
 */
export function info(message, includeTimestamp = true) {
 ...
 * @param includeTimestamp Whether to include a timestamp
 */
export function success(message, includeTimestamp = true) {
 ...
 * @param includeTimestamp Whether to include a timestamp
 */
export function warn(message, includeTimestamp = true) {
 ...
 * @param includeTimestamp Whether to include a timestamp
 */
export function error(message, includeTimestamp = true) {
 ...
 */
export function progress(message, current, total, width = 30) {
    if (!shouldLog('info'))
        return;
 ...
 */
export function table(data, title, level = 'info') {
    if (!shouldLog(level) || data.length === 0)
        return;
    if (title) {
 ...
 */
export function separator(level = 'info', char = '=', length = 80) {
    if (!shouldLog(level))
        return;
 ...
 */
export function section(title, level = 'info') {
    if (!shouldLog(level))
        return;
    separator(level);
