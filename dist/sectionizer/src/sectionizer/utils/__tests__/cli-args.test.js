...
import { parseCommandLineArgs, configureCommandLineParser, validatePdf, configureUtilityCommandParser, parseUtilityArgs } from '../cli-args.js';
...
describe('CLI Arguments Module', () => {
    ...
    describe('validatePdf', () => {
        test('should return isValid: true for valid PDF', async () => {
            ...
            vi.mocked(fsPromises.open).mockResolvedValue(mockFileHandle);
