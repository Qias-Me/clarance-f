...
describe('RuleEngine', () => {
    ...
    describe('constructor', () => {
        it('should initialize with the specified rules directory', () => {
            ...
            expect(customEngine.rulesDir).toBe(customDir);
        });
        it('should use default rules directory if not specified', () => {
            ...
            expect(defaultEngine.rulesDir).toContain(path.join('src', 'sectionizer', 'rules'));
        });
    });
    describe('loadRules', () => {
        ...
        it('should load rules from all JSON files in the rules directory', async () => {
            ...
            fs.readdirSync.mockReturnValue(['01.json', '02.json']);
            ...
            expect(engine.sectionRules[1]).toBeDefined();
            expect(engine.sectionRules[2]).toBeDefined();
        ...
        it('should handle invalid rule files gracefully', async () => {
            ...
            fs.readdirSync.mockReturnValue(['valid.json', 'invalid.json']);
    ...
    describe('categorizeField', () => {
        ...
        beforeEach(() => {
            ...
            engine.strictSectionPatterns = {
                4: [/section4_strict/i]
            };
        });
        it('should match field based on name pattern', () => {
            const field = { id: '1', name: 'section1_field', value: '', page: 1 };
        ...
        it('should extract entry index from pattern match', () => {
            const field = { id: '3', name: 'section2a5_field', value: '', page: 2 };
            const result = engine.categorizeField(field);
            expect(result).toBeDefined();
        ...
        it('should prioritize strict patterns for critical sections', () => {
            const field = { id: '6', name: 'section4_strict', value: '', page: 4 };
            const result = engine.categorizeField(field);
            expect(result).toBeDefined();
        ...
        it('should return undefined if no rules match', () => {
            const field = { id: '7', name: 'no_match', value: '', page: 10 };
            const result = engine.categorizeField(field);
    ...
    describe('categorizeFields', () => {
        ...
        it('should apply post-categorization validation', () => {
            ...
            const validateSpy = jest.spyOn(engine, 'validateSectionAssignments');
