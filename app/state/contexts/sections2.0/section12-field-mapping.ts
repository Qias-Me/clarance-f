...
const section12Fields: Section12Field[] = section12Data.fields as Section12Field[];

// Create mappings for quick lookup
const fieldNameToDataMap = new Map<string, Section12Field>();
const fieldIdToDataMap = new Map<string, Section12Field>();
 ...
 */
export const SECTION12_FIELD_MAPPINGS = {
...
export function mapLogicalFieldToPdfField(logicalPath: string): string {
  return SECTION12_FIELD_MAPPINGS[logicalPath as keyof typeof SECTION12_FIELD_MAPPINGS] || logicalPath;
}

/**
 * Get field metadata for a PDF field name
 */
export function getFieldMetadata(pdfFieldName: string): Section12Field | undefined {
 ...
 */
export function getFieldById(numericId: string): Section12Field | undefined {
 ...
 */
export function findSimilarFieldNames(targetName: string, limit: number = 5): string[] {
 ...
 */
export function getEntryFieldMappings(entryIndex: number): Record<string, string> {
 ...
 */
export function validateSection12FieldMappings(): {
  totalFields: number;
  mappedFields: number;
  coverage: number;
  ...
  const mappedFieldNames = new Set(Object.values(SECTION12_FIELD_MAPPINGS) as string[]);
