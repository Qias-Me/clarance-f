...
export async function loadSection13Mappings(): Promise<Section13Mapping[]> {
  try {
    ...
    // Fallback mappings disabled to avoid stale uiPaths; return empty list.
    return [];
  }
}
...
function getHardcodedFields(): Section13Field[] {
  // Minimal placeholder dataset without uiPath literals
  return [
 ...
 */
function getHardcodedMappings(): Section13Mapping[] { return []; }
 ...
 */
function convertValueToUiPath(_value: string): string { return ''; }
