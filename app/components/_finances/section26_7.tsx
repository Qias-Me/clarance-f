...
import type { Section26_7 } from "api/interfaces/sections/finances";

interface Section26_7Props {
  data: Section26_7[];
  onInputChange: (path: string, value: any) => void;
  onRemoveEntry: (path: string, index: number) => void;
  onAddEntry: (path: string, newItem: Section26_7) => void;
  path: string;
...
const RenderSection26_7: React.FC<Section26_7Props> = ({
  data,
  onInputChange,
  onRemoveEntry,
  onAddEntry,
  ...
  const handleTypeCheckboxChange = (
    ...
    onInputChange(`${path}.section26_7[${index}].${field}`, updatedSpecify);
  };
  ...
  const handleBlur =
    ...
    (event: React.FocusEvent<HTMLInputElement>) => {
      ...
      onInputChange(
        `${path}.section26_7[${index}].${fieldPath}`,
        formattedValue
      );
    };
    ...
    (
      ...
      const value =
        event.target.type === "checkbox"
          ...
          : event.target.value;
      onInputChange(`${path}.section26_7[${index}].${fieldPath}`, value);
    };
  ...
  const renderEntry = (item: Section26_7, index: number) => {
      ...
      <div key={index} className="space-y-4 p-4 border rounded-lg">
        ...
        <label>
          ...
          <input
            ...
            readOnly={isReadOnlyField(`section26_7[${index}].agencyName`)}
          />
        </label>
        ...
        {renderBooleanInput(
          ...
          item.doesInclude,
          (value) => {
            onInputChange(`${path}.section26_7.[${index}].doesInclude`, value);
            if (!value) {
              onInputChange(
                `${path}.section26_7.[${index}].financialIssueTypes`,
                []
              );
            }
          }
        ...
        <label>
          ...
          <input
            ...
            readOnly={isReadOnlyField(
              `section26_7[${index}].loanAccountNumbers`
            )}
          />
        </label>
        ...
        <label>
          ...
          <input
            ...
            readOnly={isReadOnlyField(`section26_7[${index}].propertyInvolved`)}
          />
        </label>
        ...
        <label>
          ...
          <input
            ...
            readOnly={isReadOnlyField(`section26_7[${index}].amount.amount`)}
          />
          <input
            type="checkbox"
            checked={item.amount.estimated}
            onChange={handleInputChange(index, "amount.estimated")}
            readOnly={isReadOnlyField(`section26_7[${index}].amount.estimated`)}
          />
          Estimated
        </label>
        ...
        <label>
          ...
          <input
            ...
            readOnly={isReadOnlyField(`section26_7[${index}].issueReason`)}
          />
        </label>
        ...
        <label>
          ...
          <input
            ...
            readOnly={isReadOnlyField(`section26_7[${index}].currentStatus`)}
          />
        </label>
        ...
        <label>
          ...
          <input
            ...
            readOnly={isReadOnlyField(`section26_7[${index}].issueDate.date`)}
          />
          <input
            type="checkbox"
            ...
            readOnly={isReadOnlyField(
              `section26_7[${index}].issueDate.estimated`
            )}
          />
          Estimated
        </label>
        ...
        <label>
          ...
          <input
            ...
            readOnly={isReadOnlyField(
              `section26_7[${index}].resolutionDate.date`
            )}
          />
          <input
            type="checkbox"
            ...
            readOnly={isReadOnlyField(
              `section26_7[${index}].resolutionDate.estimated`
            )}
          />
          Estimated
        </label>
        ...
        <label>
          ...
          <input
            ...
            readOnly={isReadOnlyField(`section26_7[${index}].courtName`)}
          />
        </label>
        ...
        <label>
          ...
          <input
            ...
            readOnly={isReadOnlyField(
              `section26_7[${index}].courtAddress.street`
            )}
            placeholder="Street"
          />
        </label>
        ...
        <label>
          ...
          <input
            ...
            readOnly={isReadOnlyField(
              `section26_7[${index}].courtAddress.city`
            )}
            placeholder="City"
          />
        </label>
        ...
        <label>
          ...
          <input
            ...
            readOnly={isReadOnlyField(
              `section26_7[${index}].courtAddress.state`
            )}
            placeholder="State"
          />
        </label>
        ...
        <label>
          ...
          <input
            ...
            readOnly={isReadOnlyField(
              `section26_7[${index}].courtAddress.zipCode`
            )}
        ...
        <label>
          ...
          <input
            ...
            readOnly={isReadOnlyField(
              `section26_7[${index}].courtAddress.country`
            )}
            placeholder="Country"
          />
        </label>
        ...
        <label>
          ...
          <textarea
            ...
            readOnly={isReadOnlyField(`section26_7[${index}].actionsTaken`)}
          />
        </label>
        ...
        <button
          onClick={(event) => {
            ...
            onRemoveEntry(`${path}.section26_7`, index);
          }}
          disabled={isReadOnlyField(`section26_7[${index}].remove`)}
        >
          Remove Entry
        </button>
      </div>
    ...
    <div className="space-y-4">
      ...
      <button
        onClick={(event) => {
          ...
          onAddEntry(
            `${path}.section26_7`,
            getDefaultNewItem(`${path}.section26_7`)
          );
        }}
      >
        Add Entry
