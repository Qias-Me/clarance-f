...
// import { Section29_6 } from "api_v2/interfaces/association"; // Temporarily commented out
...
interface Section29_6Props {
  data: Section29_6[];
  onInputChange: (path: string, value: any) => void;
  onRemoveEntry: (path: string, index: number) => void;
  onAddEntry: (path: string, newItem: Section29_6) => void;
  path: string;
  isReadOnlyField: (fieldName: string) => boolean;
  getDefaultNewItem: (itemType: string) => any;
}

const RenderSection29_6: React.FC<Section29_6Props> = ({
  data,
  onInputChange,
  onRemoveEntry,
  onAddEntry,
    ...
    (
      ...
      const value =
        event.target.type === "checkbox"
          ...
          : event.target.value;
      onInputChange(`${path}.section29_6[${index}].${fieldPath}`, value);
    };

  const renderEntry = (item: Section29_6, index: number) => (
    <div key={index} className="space-y-4 p-4 border rounded-lg">
      ...
      <div>
        ...
        <textarea
          ...
          readOnly={isReadOnlyField(`section29_6[${index}].activityDescription`)}
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          readOnly={isReadOnlyField(`section29_6[${index}].dateRange.from.date`)}
        />
        ...
        <input
          ...
          readOnly={isReadOnlyField(`section29_6[${index}].dateRange.from.estimated`)}
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          readOnly={isReadOnlyField(`section29_6[${index}].dateRange.to.date`)}
        />
        ...
        <input
          ...
          readOnly={isReadOnlyField(`section29_6[${index}].dateRange.to.estimated`)}
        />
        ...
        <input
          ...
          readOnly={isReadOnlyField(`section29_6[${index}].dateRange.present`)}
        />
      </div>
      ...
      <button
        onClick={(event) => {
          ...
          onRemoveEntry(`${path}.section29_6`, index);
        }}
        disabled={isReadOnlyField(`section29_6[${index}].remove`)}
      >
        Remove Entry
      </button>
    </div>
    ...
    <div className="space-y-4">
      ...
      <button
        onClick={(event) => {
          ...
          onAddEntry(
            `${path}.section29_6`,
            getDefaultNewItem(`${path}.section29_6`)
          );
        }}
      >
        Add Entry
