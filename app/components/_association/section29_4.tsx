...
// import { Section29_4 } from "api_v2/interfaces/association"; // Temporarily commented out
...
interface Section29_4Props {
  ...
  onAddEntry: (path: string, newItem: Section29_4) => void;
  path: string;
  isReadOnlyField: (fieldName: string) => boolean;
  getDefaultNewItem: (itemType: string) => any;
}

const RenderSection29_4: React.FC<Section29_4Props> = ({
  data,
  onInputChange,
  onRemoveEntry,
  onAddEntry,
    ...
    (
      ...
      const value =
        event.target.type === "checkbox"
          ...
          : event.target.value;
      onInputChange(`${path}.section29_4[${index}].${fieldPath}`, value);
    };

  const renderEntry = (item: Section29_4, index: number) => (
    <div key={index} className="space-y-4 p-4 border rounded-lg">
      ...
      <div>
        ...
        <input
          ...
          readOnly={isReadOnlyField(`section29_4[${index}].organizationName`)}
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          readOnly={isReadOnlyField(`section29_4[${index}].organizationAddress.street`)}
        />
        ...
        <input
          ...
          readOnly={isReadOnlyField(`section29_4[${index}].organizationAddress.city`)}
        />
        ...
        <input
          ...
          readOnly={isReadOnlyField(`section29_4[${index}].organizationAddress.state`)}
        />
        ...
        <input
          ...
          readOnly={isReadOnlyField(`section29_4[${index}].organizationAddress.zipCode`)}
        />
        ...
        <input
          ...
          readOnly={isReadOnlyField(`section29_4[${index}].organizationAddress.country`)}
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          readOnly={isReadOnlyField(`section29_4[${index}].involvementDateRange.from.date`)}
        />
        ...
        <input
          ...
          readOnly={isReadOnlyField(`section29_4[${index}].involvementDateRange.from.estimated`)}
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          readOnly={isReadOnlyField(`section29_4[${index}].involvementDateRange.to.date`)}
        />
        ...
        <input
          ...
          readOnly={isReadOnlyField(`section29_4[${index}].involvementDateRange.to.estimated`)}
        />
        ...
        <input
          ...
          readOnly={isReadOnlyField(`section29_4[${index}].involvementDateRange.present`)}
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          readOnly={isReadOnlyField(`section29_4[${index}].positionsHeld`)}
        />
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          readOnly={isReadOnlyField(`section29_4[${index}].contributions`)}
        />
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          readOnly={isReadOnlyField(`section29_4[${index}].natureOfInvolvement`)}
        />
      </div>
      ...
      <button
        onClick={(event) => {
          ...
          onRemoveEntry(`${path}.section29_4`, index);
        }}
        disabled={isReadOnlyField(`section29_4[${index}].remove`)}
      >
        Remove Entry
      </button>
    </div>
    ...
    <div className="space-y-4">
      ...
      <button
        onClick={(event) => {
          ...
          onAddEntry(
            `${path}.section29_4`,
            getDefaultNewItem(`${path}.section29_4`)
          );
        }}
      >
        Add Entry
