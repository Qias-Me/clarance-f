...
// Enhanced configuration for flexible path resolution
...
let currentConfig: PathConfig = { ...DEFAULT_CONFIG };
 ...
 */
export const updatePathConfig = (config: Partial<PathConfig>): void => {
 ...
 */
export const enableValidationMode = (): void => {
  updatePathConfig({
 ...
 */
export const resolvePathWithAbsoluteSupport = (userPath: string): string => {
