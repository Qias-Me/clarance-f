...
export class BrowserFieldMappingService {
   ...
   */
  mapSelectiveServiceFields(fieldHierarchy: any, serviceInfoContext: any): any {
    try {
   ...
   */
  mapMentalHealthFields(fieldHierarchy: any, mentalHealthContext: any): any {
    try {
   ...
   */
  mapInvestigationsFields(fieldHierarchy: any, investigationsContext: any): any {
    try {
   ...
   */
  mapAlcoholFields(fieldHierarchy: any, alcoholUseContext: any): any {
    try {
   ...
   */
  mapFinancesFields(fieldHierarchy: any, financesContext: any): any {
    try {
   ...
   */
  mapTechnologyUseFields(fieldHierarchy: any, technologyContext: any): any {
    try {
   ...
   */
  mapAssociationFields(fieldHierarchy: any, associationContext: any): any {
    try {
   ...
   */
  mapRelativesFields(fieldHierarchy: any, relativesContext: any): any {
    try {
